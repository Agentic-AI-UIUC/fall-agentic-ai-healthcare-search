...
class PageClassifier:
    def __init__(self, labels: list, positive_index: int = 0, threshold: float =.85) -> None:
...
if __name__ == "__main__":
    classifier = PageClassifier(["related to mental illness","unrelated to mental illness"])
